...
function renderCustomerQuote(calc){
  ...
  <div class="xlsQuote customer">
    <div class="xlsTop">
      ...
      <div class="xlsCompany"><img class="staffBrand" src="assets/staff_brand.png" alt="LX하우시스 공식대리점"><div class="staffCompany">공식대리점<br><b>주식회사 도도</b></div><div class="staffPerson"><span>담당자</span><b>${staff.name}</b><strong>${staff.phone}</strong></div><div class="staffAddress">${staffAddress}</div></div>
